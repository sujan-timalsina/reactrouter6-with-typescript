...
import { ContactTypes, updateContact } from "../contacts";
...
export const action: ActionFunction = async ({ request, params }) => {
    const typedParams = params as unknown as ContactLoaderParams;

    const formData = await request.formData();
    const updates: Partial<ContactTypes> = Object.fromEntries(formData);
